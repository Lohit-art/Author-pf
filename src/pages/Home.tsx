        ...
        <div className="container-custom relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-neutral-700 mb-8 leading-relaxed">
                I'm S. Nimma, author of this fictional yet emotionally rooted story inspired by real psychological patterns and silenced truths. Told in a fragmented, stream-of-consciousness style, Curled Crystal explores mental health, trauma, and self-discovery, mirroring the inner chaos of disorders like BPD, bipolar disorder, and PTSD, alongside patriarchal and cultural silencing. Set in the grey zones of morality and psychology, this is a journey that asks you not to judge, but to feel, question, and remember.
              </p>
